...
```shell
dockermgr download src bash
```

OR

```shell
git clone "https://github.com/casjaysdevdocker/bash" "$HOME/Projects/github/casjaysdevdocker/bash"
```

## Build container  

```shell
cd "$HOME/Projects/github/casjaysdevdocker/bash"
buildx 
```
